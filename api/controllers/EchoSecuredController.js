 ...
 */
class EchoSecuredController {
  /**
   * Implementation for path '/echo_secured' method POST. Receives an echoMessage and responds with it. If the
   ...
   * @param next
   */
  static echoSecuredPost(req, res) {
    // Set a good status
    res.status(200);
...
module.exports = EchoSecuredController;
